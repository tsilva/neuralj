...
public class ConsoleWatcher implements IWatcher, Serializable
{
	...
	public void monitor()
	{
		System.out.println("Epoch: " + this.algorithm.current_epoch + " Training MSE: " + this.algorithm.current_training_error + " Validation MSE: " + this.algorithm.current_validation_error);
	}
